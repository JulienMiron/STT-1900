...
\item Si on retire une variable du modèle (p.ex. $X_4$), les estimations des coefficients de régression pour les autres variables (p.ex. $\beta_1,\,\beta_2,\,\beta_3$) sont susceptibles de changer.
...
\begin{enumerate}\itemsep 1mm
  ...
  \item Le minimum de $E(Y)$ est atteint en  $x=-\dfrac{\beta_1}{2\beta_2}$.
  \end{enumerate}
