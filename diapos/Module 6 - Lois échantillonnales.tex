...
qu'ils peuvent, en moyenne, soutenir une masse de 10 tonnes.
...
\end{Boite}
   ...
   En pratique, on a une grande (voire infinie) population d'objets ou d'individus et la valeur de $X$ varie d'un individu à l'autre dans la population selon $F_X$. On choisit au hasard $n$ individus dans cette population et les valeurs $X_1,\dots,X_n$ de $X$ que l'on obtient forment un échantillon aléatoire.
...
\centerline{\LARGE\bf\alert{QUIZ !}}
  ...
  Mon meilleur ami tire ensuite lui aussi un échantillon aléatoire de taille 16 de cette même population. Il en calcule la moyenne échantillonnale, que l'on dénote $\overline{X}^B$.
...
Quelle est la probabilité que la moyenne échantillonnale soit supérieure à la vraie moyenne $\mu$ par plus d'un écart-type échantillonnal ?
...
\begin{frame}{Loi échantillonnale de $S^2_X/S^2_Y$}
   ...
   \begin{Boite}{Loi échantillonnale de $S^2_X/S^2_Y$}
