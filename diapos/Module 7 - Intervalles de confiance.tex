...
\vspace{2cm}
\href{https://jmiron-icintro.share.connect.posit.cloud/}{Illustration.}
...
\begin{frame}[t] \frametitle{Exemple 1 }
 ...
 \vspace{4.5cm}
\href{https://jmiron-icvarconnue.share.connect.posit.cloud/}{Illustration}
...
\item 95\% des disques de cette compagnie ont un diamètre entre 12,03 et 12,07 cm. \href{https://jmiron-vfvarconnue.share.connect.posit.cloud/}{Illustration}
...
\item Si on prenait un nouvel échantillon de taille $n=9$, la probabilité que sa moyenne $\overline X$ soit entre 12,03 et 12,07 cm est de 95\%. \href{https://jmiron-vfvarconnue.share.connect.posit.cloud/}{Illustration}
\end{itemize}
