...
En supposant que la loi normale est appropriée pour les résistances, peut-on conclure au seuil $\alpha = 0,10$ que la variabilité des résistances des deux fournisseurs sont différentes?
...
\subsection{Cas 1: Populations normales, variances connues, échantillons indépendants}
...
\begin{enumerate}
  \item  $H_0:\sigma_1^2=\sigma_2^2$ contre $H_1:\sigma_1^2\ne\sigma_2^2$. Puisque $0,135<f_0=0,59<9,36$ ($\alpha^*=0,57$), on ne rejette pas l'égalité des variances.\\
      $H_0:\mu_1=\mu_2$ contre $H_1:\mu_1>\mu_2$. Puisque $t_0=0,757\not>1,83$ ($\alpha^*=0,234$), on ne rejette pas $H_0$. La concentration moyenne de la rivière 1 n'excède pas celle de la rivière 2 de façon significative.
