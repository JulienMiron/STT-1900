...
On dit que $X$ suit une loi normale d'espérance $\mu$ et de variance $\sigma^2$, dénotée
...
\includegraphics[scale = 0.3]{Images/Module 3/aire_proba.png}    \includegraphics[scale = 0.45]{Images/Module 3/Normale_repart.pdf}
...
Si les $X_i$ sont conjointement normales mais pas indépendantes, leurs combinaisons linéaires suivent quand même des lois normales et avec les moyennes données ci-dessus, mais les \alert{formules de variances doivent être ajustées afin de tenir compte des covariances (mesures de dépendance)}.
