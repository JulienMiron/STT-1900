...
\vfill
    \href{https://019fb411-aa6f-c838-1732-d3f86e705246.share.connect.posit.cloud/}{Simulons cette expérience !}
...
\vspace{0.5cm}
\vfill
    \href{https://019fb410-e0e6-81d3-48e5-52f2c8f6cbc5.share.connect.posit.cloud/}{Simulation.}
\end{frame}
...
\vspace{0.5cm}
\vfill
    \href{https://019fb411-aa6f-c838-1732-d3f86e705246.share.connect.posit.cloud/}{P.ex., si $\mu=10$, $\sigma^2=4$ et $n=16$, alors $\overline{X}\sim\mathcal{N}(10,4/16)$ ... simulons !}
   }
\end{frame}
...
\begin{frame}[t]{Standardisation}
  ...
  \vspace{0.5cm}
\vfill
    \href{https://019fb411-aa6f-c838-1732-d3f86e705246.share.connect.posit.cloud/}{Retour à la simulation ...}
\end{frame}
...
\vspace{9cm}}
\end{minipage}
\begin{minipage}[b]{7.6cm}{\includegraphics[width=7.6cm]{table_khi2.pdf}} \end{minipage}
...
\begin{frame}[t]{Exemple 3}
    ...
    \href{https://019fb40b-f3bc-c012-ac7e-62e30d450bcc.share.connect.posit.cloud/}{Simulation, question de mettre les calculs en contexte ...}
\end{frame}
...
\href{https://019fb412-8d31-a2a9-4757-8c4f4a21997f.share.connect.posit.cloud/}{Simulation}
...
\vspace{9cm}}
\end{minipage}
\begin{minipage}[b]{7.6cm}{\includegraphics[width=7.6cm]{table_t.pdf}} \end{minipage}
...
\end{Boite}
 ...
 \href{https://019fb413-3991-3ed5-705f-2c27a62e3fbc.share.connect.posit.cloud/}{Graphiquement}
\end{frame}
...
\vspace{4cm}}
\end{minipage}
\begin{minipage}[b]{8cm}{\includegraphics[width=10.5cm]{Fisher01_1.pdf}} \end{minipage}
