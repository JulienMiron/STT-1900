...
%  \item 13\% sont des garçons  satisfaits de leurs études.
 ...
 Pouvez-vous maintenant déterminer la probabilité qu'un employé choisi au hasard...
     \begin{enumerate}\itemsep 5mm
      ...
      \item[(iii)] n'ait pas de maîtrise et habite à moins de 30 km de son lieu de travail? %0.30
...
\item[b)] On vous donne une pièce défectueuse. Quelle est la probabilité qu'elle provienne de l'usine B?
     \end{enumerate}
\end{frame}
\end{comment}
...
\begin{enumerate}
  ...
  \item $P(\overline M)=0,45,\;P(M\cap H)=0,45,\;P(\overline M\cap H)=0,30, \; P(\overline M\cap H\cap T)=ND,\;P(H\cup M)=0,85,\;P(M|H)=0,6,\;P(T|M)=7/11$
