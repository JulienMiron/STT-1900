...
\href{https://jmiron-modeleintro.share.connect.posit.cloud/}{Illustration}
\end{frame}
...
\centerline{\includegraphics[height=6.5cm]{Images/Module 10/RLS1b-pts.png}}
\end{frame}

\begin{frame}[t]{Éléments du modèle de RLS}
\centerline{\includegraphics[height=6.5cm]{Images/Module 10/RLS1b-theo.png}}
\end{frame}
...
\centerline{\includegraphics[height=5.25cm]{Images/Module 10/extrapol-vide.png}}
\end{frame}
...
\centerline{\includegraphics[height=5.25cm]{extrapol.jpg}}
\end{frame}
...
\begin{frame}[t]{Éléments du modèle de RLS}
\centerline{\includegraphics[height=6.5cm]{Images/Module 10/RLS1b-fit.png}}
\end{frame}
...
\href{https://jmiron-anova.share.connect.posit.cloud/}{Illustration}
...
\begin{frame}[t]{Règles de décision}
Le cas qui nous intéressera le plus souvent est $H_0:~\beta_1=0$.
\medskip
...
de régression $\beta_1$ et la valeur
du coefficient de corrélation $\rho=corr(X,Y)$}.

\vspace{1cm}

\href{https://jmiron-reglincorr.share.connect.posit.cloud/}{Illustration}
\end{frame}
...
{\small
\begin{tabular}{ccc}
\includegraphics[width=3cm]{rho9.png}&\includegraphics[width=3cm]{rho6.png}&\includegraphics[width=3cm]{rho1.png}\\
...
\begin{tabular}{ll}
\includegraphics[width=1.8in]{Ex9_4-R1.png} &\includegraphics[width=1.8in]{Ex9_7-R1.png}\\
\includegraphics[width=1.8in]{Ex9_7-R3.jpg} & \includegraphics[width=1.8in]{Ex9_7-R2.jpg}
\end{tabular}
\end{frame}
